					...
					<section class="box special">
						<header class="major" id="event_description">
							...
							<p style="margin-bottom: 1.5em;">
								To protect the human civilization from white walkers it’s time to construct an engineered wall or a historic walls, which can resist the attack from them. The ground conditions(ie,soil types) are different for which you will have to build a different wall as each and every wall strength and stability depends on that. On the final day of the attack you will be judged on the total accumulated points answering the questions. Brush up your skills to enjoy a mind bending game to experience one of the world’s most viewed show.
							</p>
						...
						<header class="major" id="rules" style="display: none;">
							...
							<p style="margin-bottom: 1.5em;">
								...
								3. Answer the questions without the units; the units in which the questions have to be answered will be specified.<br />
								4. The event will end on the last day of tech tatva. <br />
								5. Questions can have multiple answers.<br/>
								6. Only the correct answered to be given in case of Multiple Choice Answers(MCQ).
							</p>
