...
// convert the string to all lowercase
     ...
     else if($_POST['answer']==$row2['answer'])
     {
            ...
            $_SESSION['question_new_level'] = $questions['Question'];
            
            echo $question_new_level;
            
            $_SESSION['clue_image']= $questions['Image'];
            
            $_SESSION['main_image'] = $questions['MainImage'];
           ...
           $_SESSION['arr'][] = $questions['digit'];
            ...
            $_SESSION['div_num'] = $questions['digit'];
...
<div id="image_clue_div"><img src="q3.jpeg"></div>
