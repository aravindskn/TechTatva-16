...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2016 at 11:14 AM
...
INSERT INTO `questions` (`id`, `question`, `answer`, `points`) VALUES
(1, 'A bank offers 5% of compound interest on half yearly basis. A customer deposits 1600 Rs. each on 1st January and 1st July of the year .At the end of the year the amount he would have gained by the way of interest is?', '121', 3),
(46, 'Six bells commence tolling together and toll at interval of 2, 4, 6, 8, 10 and 12 secs respectively. In 30 minutes, how many times do they toll together?', '16', 3),
(47, 'Two trains running in opposite directions cross a man standing on the platform in 27 secs and 17 secs respectively and they cross each other in 23 secs. The ratio of their speeds is ?', '3:2', 3);
...
CREATE TABLE `users` (
  ...
  `choice` varchar(50) NOT NULL DEFAULT 'all'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `users` (`id`, `Name`, `points`, `level`, `choice`) VALUES
(1, 'Test', 0, 1, 'all');
